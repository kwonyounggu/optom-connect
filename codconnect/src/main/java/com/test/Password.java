...
public class Password
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		String compare_test = isValidPassword(test_passwd, test_hash) ? "Passwords Match" : "Passwords do not match";
		String compare_computed = isValidPassword(test_passwd, computed_hash) ? "Passwords Match"
