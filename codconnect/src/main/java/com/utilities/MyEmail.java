...
public class MyEmail
{
	...
	public static void emailSignupConfirmationHtml(AuthUserDetailsInternalBean ab) throws EmailException
	{
		String emailMsg =
		"<html>" +
		"<style>" +
				...
				"<tr>" +
					...
					"<td colspan='3'>" +
						"<p style='padding: 10px'>Hello Eye Care Provider,<br /><br /><br />" +
						   ...
						   "<br /><br />" +
						   "<a style='color: inherit' href='"+Utils.MYHOST_DOMAIN + "/activate?op=signup&token=" +ab.getEmailConfirmationToken() + "'>Confirmation Link</a><br />" +
						   Utils.MYHOST_DOMAIN + "/activate?op=signup&token=" +ab.getEmailConfirmationToken() + "<br /><br />" +
						   "Thanks!<br /><br />" +
						   "- The Optom-Connect Team<br /><br />" +
						"</p>" +
					"</td>" +
					"<td></td>" +
				"</tr>" +
