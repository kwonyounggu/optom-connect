...
const NavRoot=(props)=>
{
    ...
    else switch(pathname)
    {
		...
		case (pathname.match(/^\/eye_health[\/]?/i) || {}).input: { currentMenu=<Redirect to='/eye_health' />; break;}
		case (pathname.match(/^\/optometrist[\/]?/i) || {}).input: { currentMenu=<Redirect to='/optometrists' />; break;}
